...
const CourseOverviewScreen = ({
  ...
  return (
    <BaseScreen>
      <View className="flex-1 bg-surfaceSubtleCyan">
        <ScrollView
          className="flex-1 bg-surfaceSubtleCyan"
          showsVerticalScrollIndicator={false}
          contentContainerStyle={styles.scrollContent}
        >
          {/* Header Section with Image, Back Button & Overlapping Card */}
          <View className="relative" style={styles.headerContainer}>
            {/* Course Image */}
